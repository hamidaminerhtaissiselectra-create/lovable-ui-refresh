...
const etapes = [
  ...
  { num: "05", title: "Vérification & garantie", desc: "Nous testons le bon fonctionnement du volet et vous remettons votre certificat de garantie. Toutes nos réparations sont garanties 2 ans.", color: "bg-service-violet" },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                { icon: Shield, text: "Garantie 2 ans", color: "bg-service-emerald/20 border-service-emerald/30 text-primary-foreground" },
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  { icon: Shield, label: "Garantie 2 ans", desc: "Pièces et main d'œuvre", color: "border-service-emerald/20", iconColor: "bg-service-emerald/10 text-service-emerald" },
                  ...
                  <motion.div key={item.label} whileHover={{ scale: 1.03 }} className={`bg-card rounded-xl p-5 border ${item.color} card-shadow text-center transition-all`}>
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center mx-auto mb-3 ${item.iconColor}`}>
            ...
            {pannes.map((p, i) => (
              <motion.div key={p.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-service-orange/10 flex items-center justify-center shrink-0">
                    <AlertTriangle className="h-4 w-4 text-service-orange" />
                  </div>
