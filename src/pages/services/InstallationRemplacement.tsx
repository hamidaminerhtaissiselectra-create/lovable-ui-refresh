...
const types = [
  ...
  { title: "Volets roulants en bois", desc: "Pour les amateurs de charme traditionnel. Le bois apporte une touche chaleureuse et authentique tout en offrant d'excellentes propriétés isolantes naturelles.", points: ["Esthétique noble", "Isolation naturelle", "Éco-responsable", "Restauration possible"], color: "border-service-orange/20", badge: "Premium", badgeColor: "bg-service-orange/10 text-service-orange border-service-orange/20" },
];
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {avantages.map((a, i) => (
              <motion.div key={a.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                ...
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-4 ${a.iconColor}`}>
