...
const regions = [
  ...
  },
  {
    ...
    services: ["Intervention sous 72h", "Devis gratuit à distance", "Techniciens qualifiés", "Garantie décennale"],
  },
  {
    name: "Grand Est",
    slug: "grand-est",
  ...
  },
  {
    ...
    services: ["Solutions anti-corrosion", "Volets résistants aux intempéries", "Intervention planifiée", "Garantie décennale"],
  },
  {
    name: "Bretagne",
    slug: "bretagne",
  ...
  },
  {
    ...
    services: ["Plus grande région couverte", "Solutions littoral/montagne", "Partenaires locaux", "Garantie décennale"],
  },
  {
    name: "Occitanie",
    slug: "occitanie",
