      ...
      <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-3">
          ...
          <Button asChild variant="outline" className="border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 gap-2">
            <a href="tel:0164070000"><Phone className="h-4 w-4" /> Appeler</a>
          </Button>
        </div>
      </div>
    </div>
      ...
      <div className="grid md:grid-cols-4 gap-10 mb-10">
        <div>
          ...
          <p className="text-primary-foreground/70 text-sm leading-relaxed mb-4">
            Spécialiste de la réparation et de l'installation de volets roulants en Île-de-France depuis plus de 10 ans. Qualité, rapidité et garantie décennale.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/70">
            ...
            <li><a href="#services" className="hover:text-primary-foreground transition-colors">Vitrerie & Vitrage</a></li>
            <li><a href="#services" className="hover:text-primary-foreground transition-colors">Motorisation & Domotique</a></li>
            <li><a href="#services" className="hover:text-primary-foreground transition-colors">Installation complète</a></li>
            <li><a href="#services" className="hover:text-primary-foreground transition-colors">Dépannage express</a></li>
          </ul>
        </div>
