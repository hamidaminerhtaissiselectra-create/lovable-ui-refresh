...
const faqs = [
  ...
  { q: "Intervenez-vous en urgence le week-end ?", a: "Oui, nous proposons un service d'intervention d'urgence 7j/7 pour les cas de volets bloqués en position ouverte, bris de glace ou problèmes de sécurité. Contactez-nous au 01 64 07 XX XX pour une intervention rapide." },
  ...
  { q: "Quelle est votre zone d'intervention ?", a: "Basés à Fontenay-Trésigny (77), nous intervenons principalement en Île-de-France (Paris et tous les départements 77, 93, 94, 91, 78, 92, 95). Nous pouvons également intervenir dans d'autres régions pour des projets d'envergure." },
